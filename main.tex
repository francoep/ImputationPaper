...
%This was tested by bootstrapping the ensemble RMSE 10,000 times for each entry in Table~\ref{tab:roche}.
%We then subtracted these 10,000 RMSE values for one set of models from another, and calculated the 95\% confidence interval of the values of the difference.
%If said confidence interval did not overlap zero, then the difference between the two reported RMSE values was considered statistically significant.
